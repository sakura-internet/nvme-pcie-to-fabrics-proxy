...
set_property PROGRAM.FILES [list "output/${top_module_name}_with_elf.mcs" ] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xc7a200t_0] 0]]
set_property PROGRAM.PRM_FILE "output/${top_module_name}_with_elf.prm" [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xc7a200t_0] 0]]
